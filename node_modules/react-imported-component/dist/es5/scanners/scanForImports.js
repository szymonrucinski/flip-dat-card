...
var getImports = shared_1.getMatchString("(['\"]?[\\w-/.@]+['\"]?)\\)", 1);
...
var getImportString = function (pattern, selected) { return function (str) { return (shared_1.getMatchString(pattern, selected)(str)
...
var mapImports = function (file, imports) { return (imports
    ...
    if (name && name.charAt(0) === '.') {
        return tslib_1.__assign({}, dep, { name: path_1.resolve(path_1.dirname(file), name), doNotTransform: false });
    }
...
exports.remapImports = function (data, root, targetDir, getRelative, imports) { return (data
    .map(function (_a) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, scan_directory_1.default(path_1.join(root, start), undefined, rejectSystemFiles)];
                    case 1:
                        files = (_a.sent())
                        ...
                        return [4, Promise.all(files
                                ...
                                return tslib_1.__awaiter(this, void 0, void 0, function () {
                                    ...
                                    return tslib_1.__generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4, shared_1.getFileContent(file)];
                                            case 1:
                                                content = _a.sent();
                                                return [2, {
                                                        file: file,
                    ...
                    case 2:
                        ...
                        exports.remapImports(data, root, targetDir, shared_1.getRelative, imports);
