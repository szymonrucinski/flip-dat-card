...
var crc32 = tslib_1.__importStar(require("crc-32"));
exports.encipherImport = function (str) {
...
var resolveImport = function (importName, file) {
    ...
    if (importName.charAt(0) === '.') {
        return path_1.relative(process.cwd(), path_1.resolve(path_1.dirname(file), importName));
    }
    return importName;
};
var templateOptions = {
...
exports.createTransformer = function (_a, excludeMacro) {
        ...
        traverse: function (programPath, fileName) {
            programPath.traverse({
                ...
                Import: function (_a) {
                    ...
                    var requiredFileHash = exports.encipherImport(resolveImport(importName, fileName));
                    var replace = null;
...
function default_1(babel) {
    var transformer = exports.createTransformer(babel);
    return {
        inherits: syntax,
        visitor: {
            Program: {
